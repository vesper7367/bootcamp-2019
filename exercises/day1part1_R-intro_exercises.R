...
# use tab for shortcuts
read.csv("data/gapminder5.csv") 
...
### sort() reorders elements in ascending order, or you can flip the order by decreasing = TRUE
### order() returns the indices
...
hist(gapminder07$lifeExp, main = "Distribution of Life Expectancy Across Countries in 2007", xlab = "Life Expectancy", ylab = "Frequency", breaks = 7)
...
plot(gapminder07$lifeExp ~ gapminder07$gdpPercap, main = "Relationship between life expectancy and GDP per capita in 2007", ylab = "Life Expectancy", xlab = "GDP per capita") 
